                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $cat_id = $_POST['cat_id'];
                                        $counter = 0;
                                        $query = "INSERT INTO story (name, preview_text, detail, cat_id, picture, counter) VALUE ('{$name}','{$preview_text}','{$detail_text}',{$cat_id},'{$pictureName}',{$counter})";
                                        $result = $mysqli->query($query);
                                        if ($picture == '') {
                                            //thêm truyện không hình
                                            $queryNoPic = "INSERT INTO story (name, cat_id, preview_text, detail VALUE ('{$name}','{$cat_id}','{$preview_text}','{$detail_text}')";
                                        ...
                                        if ($result) {
                                            ...
                                            echo "Truyện thêm không thành công";
                                            die();
                                        }
                                    }
                                    ?>
