<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/adminStory/templates/admin/inc/header.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/adminStory/templates/admin/inc/leftbar.php';
?>
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (isset($picture['name']) && $picture['name'] != '') {
                                        unlink($_SERVER['DOCUMENT_ROOT'] . '/adminStory/files/' . $pictureName);
                                        //Xử lý up hình ảnh
                                        ...
                                        $pathUpload = $_SERVER['DOCUMENT_ROOT'] . '/adminStory/files/' . $pictureName;
                                        $resultUpload = move_uploaded_file($tmpName, $pathUpload);
                                    }
                                    $preview_text = $_POST['preview_text'];
                                    $detail_text = $_POST['detail'];
                                    $cat_id = $_POST['cat_id'];
                                    $query = "UPDATE story SET name = '{$name}', preview_text = '{$preview_text}', detail = '{$detail_text}', cat_id = {$cat_id}, picture = '{$pictureName}' WHERE story_id = '{$story_id}'";
                                ...
                                <form role="form" action="" method="POST" id="form-story" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if ($arStory['picture'] != '') {
                                            echo "<img src='/adminStory/files/{$arStory['picture']}' style='width: 100px;margin-top: 10px'></img>";
                                        }
                                        ?>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" rows="5" name="detail_text"><?php echo $arStory['detail'] ?></textarea>
                                    </div>
