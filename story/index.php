                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                        $query = "SELECT *, story.name AS name, cat.name AS cat_name FROM story INNER JOIN cat ON story.cat_id = cat.cat_id ORDER BY story_id DESC LIMIT {$offset}, {$row_count}";
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            ?>
                                                <img src="/adminStory/files/<?php echo $arItem['picture'];?>" alt="" height="80px" width="100px" />
                                            <?php 
                                                }
                                            ?>
                                        </td>
